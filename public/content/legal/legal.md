...
author(s): Emma Chiavegato
author_link: "https://www.linkedin.com/in/emma-chiavegato-b44549354/"
sources:
  - name: FJC — Baker v. Carr
    url: "https://www.fjc.gov/history/cases/cases-that-shaped-the-federal-courts/baker-v-carr"
  - name: Cornell Law — Baker v. Carr
    url: "https://www.law.cornell.edu/wex/baker_v_carr_(1962)"
  - name: Oyez — Baker v. Carr
    url: "https://www.oyez.org/cases/1961/6"
  - name: Justia — Gray v. Sanders
    url: "https://supreme.justia.com/cases/federal/us/372/368/"
  - name: UGA — Gray v. Sanders
    url: "https://www.libs.uga.edu/sites/default/files/capitolmuseum/gray%20v%20sanders-2.pdf"
  - name: Justia — Wesberry v. Sanders
    url: "https://supreme.justia.com/cases/federal/us/376/1/"
  - name: EBSCO — Wesberry v. Sanders
    url: "https://www.ebsco.com/research-starters/law/wesberry-v-sanders"
  - name: Library of Congress — Colegrove v. Green
    url: "https://tile.loc.gov/storage-services/service/ll/usrep/usrep328/usrep328549/usrep328549.pdf"
  - name: League of Women Voters — One Person, One Vote
    url: "https://www.lwv.org/blog/what-one-person-one-vote"
  - name: NY Supreme Court — Orange County Redistricting
    url: "https://vhdshf2oms2wcnsvk7sdv3so.blob.core.windows.net/thearp-media/documents/NY_2460_2024_70.pdf"
  - name: Oregon Legislature — Redistricting
    url: "https://www.oregonlegislature.gov/citizen_engagement/Reports/Redistricting.pdf"
  - name: Oyez — Reynolds v. Sims
    url: "https://www.oyez.org/cases/1963/23"
  - name: UMissouri — Reynolds v. Sims
    url: "https://law2.umkc.edu/faculty/projects/ftrials/conlaw/ReynoldsvSims.html"
  - name: Library of Congress — Reynolds v. Sims
    url: "https://tile.loc.gov/storage-services/service/ll/usrep/usrep377/usrep377533/usrep377533.pdf"
  - name: Justia — Davis v. Bandemer
    url: "https://supreme.justia.com/cases/federal/us/478/109/"
  - name: EBSCO — Shaw v. Reno
    url: "https://www.ebsco.com/research-starters/law/shaw-v-reno"
  - name: Street Law — Shaw v. Reno
    url: "https://store.streetlaw.org/resource/shaw-v-reno-1993/"
  - name: Federalist Society — Shaw v. Reno
    url: "https://fedsoc.org/case/shaw-v-reno"
  - name: Oyez — Miller v. Johnson
    url: "https://www.oyez.org/cases/1994/94-631"
  - name: Britannica — Miller v. Johnson
    url: "https://www.britannica.com/topic/Miller-v-Johnson"
  - name: Justia — Miller v. Johnson
    url: "https://supreme.justia.com/cases/federal/us/515/900/"
  - name: Michigan Law Review — Miller v. Johnson
    url: "https://repository.law.umich.edu/mjrl/vol1/iss1/4/"
  - name: Oyez — Shelby County v. Holder
    url: "https://www.oyez.org/cases/2012/12-96"
  - name: NAACP LDF — Shelby County v. Holder
    url: "https://naacpldf.org/shelby-county-v-holder-impact/"
  - name: Justia — Shelby County v. Holder
    url: "https://supreme.justia.com/cases/federal/us/570/529/"
  - name: ScienceDirect — Shelby County v. Holder
    url: "https://www.sciencedirect.com/science/article/pii/S0047272723002293"
  - name: DOJ — Section 5 Voting Rights Act
    url: "https://www.justice.gov/crt/about-section-5-voting-rights-act"
  - name: Federalist Society — Gill v. Whitford
    url: "https://fedsoc.org/fedsoc-review/partisan-gerrymandering-and-party-rights-why-gill-v-whitford-undermines-all-future-partisan-gerrymandering-claims"
  - name: Supreme Court — Gill v. Whitford opinion
    url: "https://www.supremecourt.gov/opinions/17pdf/16-1161_dc8f.pdf"
  - name: Supreme Court — Rucho v. Common Cause syllabus
    url: "https://www.supremecourt.gov/opinions/18pdf/18-422_9ol1.pdf"
  - name: Common Cause — Rucho v. Common Cause
    url: "https://www.commoncause.org/work/common-cause-v-rucho/"
  - name: SCOTUSblog — Rucho v. Common Cause
    url: "https://www.scotusblog.com/cases/rucho-v-common-cause-2/"
  - name: Emory Law Journal — Rucho v. Common Cause
    url: "https://scholarlycommons.law.emory.edu/elj/vol70/iss5/1/"
  - name: US Senate — 14th Amendment
    url: "https://www.senate.gov/about/origins-foundations/senate-and-constitution/14th-amendment.htm"
  - name: Cornell LII — Equal Protection Clause
    url: "https://www.law.cornell.edu/wex/equal_protection"
  - name: National Archives — Voting Rights Act
    url: "https://www.archives.gov/milestone-documents/voting-rights-act"
  - name: Congress.gov — Voting Rights Act
    url: "https://www.congress.gov/crs-product/IF12284"
...
**Malapportionment** describes the unequal distribution of population across districts. The House of Representatives has been locked at 435 voting seats since 1929. In the first Congress (1789–91), there was one representative for every roughly 57,000 people. By 1910, when the chamber first reached its modern size, the ratio was one representative for every 209,447 people. Today, it has more than tripled. As of last year, one representative serves approximately 747,000 people on average, according to the Pew Research Center. Because that average is national, the per-district population varies considerably from state to state; some representatives serve districts of just over 600,000, while others serve districts exceeding one million.

The effects of this variation can be seen in the alignment scores. A district of one million people is, almost by definition, more ideologically diverse than a district of 600,000. The larger the district, the more diverse the views that representatives must attempt to meet. In our data, more populous states tend to show lower alignment scores, and malapportionment is a meaningful part of why. The "one person, one vote" doctrine established in *Baker v. Carr* (1962) and *Reynolds v. Sims* (1964) requires roughly equal populations *within* a state's districts, but does nothing to equalize district populations *across* states. A vote in Wyoming and a vote in California are formally equal within their own systems, but the representational weight behind each looks very different.
...
Charles Baker, an urban Tennessee resident, sued his state official arguing that Tennessee's failure to redraw districts in line with population growth violated his constitutional rights. The 6-2 decision of the case gave the federal government the right to intervene in the construction of state legislative maps, which overruled the prior precedent set in Colegrove v. Green (1946), which stated that courts should stay out of state redistricting decisions. The Decision of Baker v. Carr ruled that such claims were justiciable: meaning courts could hear them.
...
A group of white voters challenged the district, arguing the district was drawn solely on the basis of race, violating the Equal Protection Clause because it put voters into racial categories.
...
White voters sued, arguing that the district's irregular shape was caused due to race, which was a violation of the Equal Protection Clause of the 14th Amendment. Both Georgia and the DOJ defended the map, arguing it was necessary to comply with the VRA and ensure meaningful minority representation in Congress.
...
Section 4(b) of the VRA defined 'covered' districts as states tha had used literacy tests and where voter turnout fell below a certain threshold in past elections. Shelby County, Alabama, sued the federal government, arguing that preclearance was essential in 1965, the coverage formula now violated equal freedoms of states.

In a 5-4 decision, the Supreme Court struck down Section 4(b) as unconstitutional, ruling that Congress had failed to update the formula to reflect current conditions. Without a valid coverage formula, Section 5 preclearance became effectively unenforceable; states could no longer be compelled to seek federal approval before changing their voting laws or redrawing district maps.
...
The supreme court's 5–4 decision ruled that partisan gerrymandering claims are nonjusticiable political questions, permanently beyond the reach of federal courts. The majority believed that federal judges' decision lacked a consistent standard for deciding when partsian influence in redistricting becomes unconstitutional because the metric is often policy-based, making it driven by judgement, so naturally it can't be a decision of the courts, "Partisan gerrymandering claims present political questions beyond the reach of the federal courts."  Chief Justice Roberts, Rucho v. Common Cause
...
The Voting Rights Act of 1965 provides a foundation of protection against redistricting techniques that limit minority communities' ability to achieve fair representation. Section 2 explicitly prohibits district lines from being drawn in any way that denies minority voters an equal opportunity to participate in any type of political process, including voting to elect their choice of a representative.

Section 2 Natioal Regulations: "prohibits states from using any "standard, practice, or procedure" to abridge or deny voting rights based on race, color, or membership in a language minority group"

Section 4 and 5 Preclearance clause: Sections 4 and 5 of the VRA established the system of preclearance. Initially enacted in 1965, through the coverage formula in the VRA section 4(b) which was applied to all of Alabama, Georgia, Louisiana, Mississippi, South Carolina, and Virginia, and much of North Carolina because these states maintained literacy tests, educational achievement or good moral character that impacted minority groups' right to vote. The coverage formula made it so these regions needed to get approval from the U.S. Attorney General or the U.S. District Court for the District of Columbia before changing any voting standard, practice, procedure, or qualification.
