...
export const alignmentLegend = [
  { key: "low", label: "Low (0.0–0.3)", color: alignmentColors.low },
  { key: "partial", label: "Partial (0.3–0.6)", color: alignmentColors.partial },
  { key: "moderate", label: "Moderate (0.6–0.8)", color: alignmentColors.moderate },
  { key: "high", label: "High (0.8–1.0)", color: alignmentColors.hight },
];
