...
// ------------------------------------- Page Widths -------------------------------------
let standardWidth = "1152px"
export const pageWidths = {
  home:        standardWidth,  // outer container
  homeIntro:   "830px",   // intro paragraph block
  state:       standardWidth,
  district:    standardWidth,
  methodology: standardWidth,
  caseStudies: standardWidth,
  about:       standardWidth,
  whatNow:     standardWidth,
  legal:       standardWidth,
};
