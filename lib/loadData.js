...
// Reads overview.json for every state directory and returns { stateCode: overall_alignment }.
// overall_alignment is null when not yet computed. Used to colour the home page choropleth.
  ...
  try {
    ...
    for (const entry of dirs) {
      ...
      try {
        ...
        scores[stateCode] = data.overall_alignment ?? null;
      } catch {
